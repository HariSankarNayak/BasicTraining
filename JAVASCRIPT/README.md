...
- Your Next step could be looking into advanced topics of [HTML5](https://code.nettantra.com/trainingmodule/BasicTraining/-/tree/master/HTML5/Semantic-tags), [CSS3] or [JavaScript]. 
- For detailed view on JavaScript look into [Advanced JavaScript Section], [JavaScript ES6 Section](https://code.nettantra.com/trainingmodule/BasicTraining/-/tree/master/JAVASCRIPT/ES6) or [TypeScript Sections](https://code.nettantra.com/trainingmodule/BasicTraining/-/tree/master/TYPESCRIPT).
- You may move forward with any famous and popular JavaScript Frameworks or Libraries like jQuery.js, [Angular](https://code.nettantra.com/trainingmodule/BasicTraining/-/tree/master/angular), React.js, NPM, Node.js, Vue.js etc. 
